...
!function (a) {
    ...
    function c(b, c) {
        if (!b.hasClass("stepper-input")) {
            ...
            var i = b.parent(".stepper"), k = a.extend({$stepper: i, $input: b, $arrow: i.find(".stepper-arrow"), min: void 0 === typeof f || isNaN(f) ? !1 : f, max: void 0 === typeof g || isNaN(g) ? !1 : g, step: void 0 === typeof h || isNaN(h) ? 1 : h, timer: null}, c);
    ...
    var l = {customClass: "", labels: {up: "Up", down: "Down"}}, m = {defaults: function (b) {
